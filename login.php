    ...
    <div class="card" style="background-color: rgba(255, 255, 255, 0.7);">
      <div class="card-body">
        ...
        <form action="actions/login.php" method="POST">
          <div class="md-form">
            <input type="email" id="email" name="email" class="form-control" style="background-color: rgba(255, 255, 255, 0.5);">
            <label for="email">Votre Email</label>
          </div>
          <div class="md-form">
            <input type="password" id="password" name="password" class="form-control" style="background-color: rgba(255, 255, 255, 0.5);">
