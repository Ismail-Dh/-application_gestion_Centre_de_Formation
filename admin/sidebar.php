        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./student-account.php" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./etudclass.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./matiere.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Les matieres</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./liste_abs.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Les listes </p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./abscence.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Les abscances</p>
                </a>
              </li>
