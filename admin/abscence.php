...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 if ($critere !== null && $valeur !== null) {
  ...
  $search_query = "SELECT etudients.ID_Etud,Nom_Etud,Prenom_Etud,ID_Class,scences.ID_seance,Date_seance,Numb_scence,abscence,abscence.ID_absc
                   FROM etudients,scences,liste_abscence,abscence
                   where etudients.ID_Etud = liste_abscence.ID_Etud and liste_abscence.ID_absc=abscence.ID_absc and abscence.ID_seance=scences.ID_seance and ";
  ...
  switch ($critere) {
     ...
     case 'absc':
            ...
            break;
     case 'date':
              $search_query .= "Date_seance = '$valeur'";
              break;
      default:
  ...
  $abs_query = 'SELECT etudients.ID_Etud,Nom_Etud,Prenom_Etud,ID_Class,scences.ID_seance,Date_seance,Numb_scence,abscence,abscence.ID_absc
             FROM etudients,scences,liste_abscence,abscence
             where etudients.ID_Etud = liste_abscence.ID_Etud and liste_abscence.ID_absc=abscence.ID_absc and abscence.ID_seance=scences.ID_seance ';
 ...
 <!-- /.content-header -->
     ...
     <section class="content">
      <div class="container-fluid">
         <!-- Buttons -->
         <div class="mb-3">
                <button type="button" class="btn btn-info" onclick="location.href='modeifier_abs.php'">Modifier une abscence</button>
                <button type="button" class="btn btn-danger" onclick="location.href='supprimer_abs.php'">Supprimer une lise d'abscence</button>
          </div>
