...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $type = mysqli_real_escape_string($db_conn, $_POST['type_fonction']);
    $idprof = mysqli_real_escape_string($db_conn, $_POST['ID_prof']);
    // Requête SQL pour insérer les données dans la table des professeurs
    $insert_query = "INSERT INTO classes (ID_Class, type_fonction, ID_prof) VALUES ('$ID','$type', '$idprof')";
