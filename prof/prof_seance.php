...
if (isset($_SESSION['prof_id'])) {
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $search_query = "SELECT ID_seance,Numb_scence,Date_seance,heur_debut,heur_fin,classes.ID_Class,nom,numero_salle
                     FROM scences,professeurs,classes,matieres
                     where scences.ID_Class=classes.ID_Class and classes.ID_prof=professeurs.ID_prof and professeurs.ID_matiere=matieres.ID_Matiere and professeurs.ID_prof='$professeur_id' and ";
   ...
   // echo "Requête SQL générée : " . $search_query; // Afficher la requête SQL générée
    ...
    $sea_query = "SELECT ID_seance,Numb_scence,Date_seance,heur_debut,heur_fin,classes.ID_Class,nom,numero_salle
                      FROM scences,professeurs,classes,matieres
